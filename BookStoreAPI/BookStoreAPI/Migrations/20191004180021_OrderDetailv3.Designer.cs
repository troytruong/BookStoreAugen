...
namespace BookStoreAPI.Migrations
{
    ...
    [Migration("20191004180021_OrderDetailv3")]
    partial class OrderDetailv3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookStoreDb.DeliveryMethod", b =>
                {
                    ...
                    b.Property<long>("DeliveryMethodCostId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("DeliveryMethodCostId");

                    b.ToTable("DeliveryMethod");
                });

            modelBuilder.Entity("BookStoreDb.DeliveryMethodCost", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("BookStoreDb.DeliveryMethod", b =>
                {
                    b.HasOne("BookStoreDb.DeliveryMethodCost", "DeliveryMethodCost")
                        .WithMany("DeliveryMethods")
                        .HasForeignKey("DeliveryMethodCostId")
